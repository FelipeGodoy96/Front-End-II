...
btn.addEventListener('click', function () {
  let inputP = document.querySelector('#password')
  let inputRP = document.querySelector('#repassword')

  if (
    inputP.getAttribute('type') == 'password' &&
    inputRP.getAttribute('type')
  ) {
    inputP.setAttribute('type', 'text')
    inputRP.setAttribute('type', 'text')
  } else {
    inputP.setAttribute('type', 'password')
    inputRP.setAttribute('type', 'password')
  }
})
